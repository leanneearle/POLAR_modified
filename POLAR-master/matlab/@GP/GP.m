classdef GP < handle
    ...
    properties (Access = public)
        ...
        ord_data
        ord_labels
        strong_pref_data % -- NORTHEASTERN --
        strong_pref_labels % -- NORTHEASTERN --
    ...
    properties ( Access = private)
        ...
        coac_pos_ind
        coac_neg_ind
        strong_pref_pos_ind % -- NORTHEASTERN --
        strong_pref_neg_ind % -- NORTHEASTERN --
        ...
        strong_pref_pos_unique_inds % -- NORTHEASTERN --
        strong_pref_neg_unique_inds % -- NORTHEASTERN --
        strong_pref_pos_repeating_inds % -- NORTHEASTERN --
        strong_pref_neg_repeating_inds % -- NORTHEASTERN --
        ...
        % ------- NORTHEASTERN -------------------------------
        strong_pref_pospos_unique_inds
        strong_pref_pospos_repeating_inds
        strong_pref_negneg_unique_inds
        strong_pref_negneg_repeating_inds
        strong_pref_posneg_unique_inds
        strong_pref_posneg_repeating_inds
        strong_pref_negpos_unique_inds
        strong_pref_negpos_repeating_inds
        % ------- NORTHEASTERN -------------------------------

        % indicator for normal vs strong preference
        extra_pref  % -- NORTHEASTERN --
    ...
    methods
        function obj = GP(settings,...
            ...
            obj.pref_noise = settings.pref_noise; %posterior noise hyperparameter for preferences
            ...
            obj.strong_pref_data = strong_pref_data; obj.strong_pref_labels = strong_pref_labels; % -- NORTHEASTERN --
            
            % Infer Bayesian posterior:
            if isempty([obj.pref_labels;obj.coac_labels;obj.ord_labels;obj.strong_pref_labels]) % -- NORTHEASTERN --
