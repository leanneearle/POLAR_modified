...
% Description: get new actions to test using information gain
% Inputs: 
%   samples = 
...
%  R = |A|x(n) matrix containing the sampled reward function used to
%       determine the next action to sample, where |A| is the number of
%       elements in the action space and n is defined as above
