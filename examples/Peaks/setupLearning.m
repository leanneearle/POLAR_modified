...
% ind = 1;
% settings.parameters(ind).name = 'peak_torque'; 
% settings.parameters(ind).discretization = 0.5;
% settings.parameters(ind).lower = 7;
% settings.parameters(ind).upper = 21;
% settings.parameters(ind).lengthscale = 5; %0.5;
% 
% % Dimension 2 
% ind = ind+1;
% settings.parameters(ind).name = 'peak_time'; 
% settings.parameters(ind).discretization = 0.5;
% settings.parameters(ind).lower = 48;
% settings.parameters(ind).upper = 60;
% settings.parameters(ind).lengthscale = 5; %0.5;
