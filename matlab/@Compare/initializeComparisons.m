...
% Description: Populate the following properties based on class inputs:
%   - obj.settings
%   - obj.setting_labels
%   - obj.num_iters
%   - obj.new_runs
...
%   varagin = variable length input arguement list
...
validationFunc = @(c) validateattributes (c, {'double'},{'<=',4,'=>',1});
