...
% Inputs: gp = gp object from GP class
%         dim_type = either 2 or 3 to represent 2D or 3D view (optional)
%         combinations = list of combination of parameters to plot (optional)
