...
% Description: Constructs obj.settings
% Inputs:
...
% -------- NORTHEASTERN -----------------------------------------------
% Synthetic Strong Preference Threshold:
if ~isfield(settings.simulation,'simulated_strong_pref_threshold')
    settings.simulation.simulated_strong_pref_threshold = 0.5; % Default is a middle threshold
end
% -------- NORTHEASTERN -----------------------------------------------
